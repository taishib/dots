...
local function _telescope(_, picker)
  return function(...)
    ...
    elseif pcall(function()
      return ext[picker]
    end) and ext[picker][picker] then
      ext[picker][picker](...)
    else
...
function M.diagnostics()
  ...
  return vim
    ...
    :filter(function(diag)
      local diag_range = Range(diag.lnum, diag.col, diag.end_lnum, diag.end_col)
...
function M.map_range(input_start, input_end, output_start, output_end, input)
  ...
  return math.min(max, math.max(min, output_start + ((input - input_start) / input_length) * output_length))
end
...
function M.visual_range()
  ...
  return math.min(vstart, cursorline), math.max(vstart, cursorline), vstart_col, cursorcol
end
